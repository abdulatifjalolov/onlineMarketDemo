...
//        telegramBotsApi.registerBot(new MyBot());
        ...
        while (true) {
            System.out.println(" 1.CATEGORY  2.PRODUCT 3.UPDATE FILES 0.BACK");
            ...
            switch (var) {
                ...
                case 3->{
                    forUpdate(BaseService.getCategories(),BaseService.getProducts());
                }
    ...
    private static void forUpdate(List<Category> categories,List<Product> products) throws IOException {
        FileUtils.writeCategoryToFile(headUrl,categories);
        FileUtils.writeProductToFile(headUrl,products);
    }
    ...
    private static void forProduct() {
        ...
        while (true) {
            ...
            switch (var1) {
                ...
                case 4 -> {
                    System.out.println(BaseService.getProducts());
                }
    ...
    private static void forCategory() {
        while (true) {
            ...
            switch (var) {
                ...
                case 3 -> {
                    System.out.println(BaseService.getCategories());
                }
